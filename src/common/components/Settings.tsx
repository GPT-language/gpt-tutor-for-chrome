    ...
    >
      ...
      >
        <FormItem
          ...
          caption={
            values.provider === 'Ollama' ? (
              <div>
                {t('Go to the')}{' '}
                <a target='_blank' href='https://github.com/ollama/ollama#ollama' rel='noreferrer' style={linkStyle}>
                  Ollama Homepage
                </a>{' '}
        ...
        >
          <FormItem
            ...
            caption={
              <div>
                {t('Go to the')}{' '}
                <a target='_blank' href='https://console.groq.com/keys' rel='noreferrer' style={linkStyle}>
                  GroqCloud
                </a>{' '}
        ...
        >
          ...
          <FormItem
            ...
            caption={
              <div>
                {t('Go to the')}{' '}
                <a target='_blank' href='https://makersuite.google.com/app/apikey' rel='noreferrer' style={linkStyle}>
                  Google AI Studio
                </a>{' '}
                {t('to get your API Key.')}
              </div>
        ...
        >
          <FormItem
            ...
            caption={
              <div>
                {t('Go to the')}{' '}
                <a target='_blank' href='https://platform.deepseek.com/api_keys' rel='noreferrer' style={linkStyle}>
                  DeepSeek Dashboard
                </a>{' '}
                {t('to get your API Key.')}
              </div>
        ...
        >
          <FormItem
            ...
            caption={
              <div>
                {t('Go to the')}{' '}
                <a target='_blank' href='https://openrouter.com/api_keys' rel='noreferrer' style={linkStyle}>
          ...
          <FormItem name='openRouterAPIModel' label={t('API Model')} required={values.provider === 'OpenRouter'}>
            <APIModelSelector
              provider='OpenRouter'
              currentProvider={values.provider}
        ...
        <FormItem
          ...
          caption={t('Allow using the clipboard to get the selected text when the selected text is not available')}
        >
      ...
      <Modal isOpen={showSocialMedia} onClose={() => setShowSocialMedia(false)} closeable size='auto' autoFocus animate>
        <ModalHeader
          style={{
            display: 'flex',
            flexDirection: 'column',
