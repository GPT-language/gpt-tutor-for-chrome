      ...
      overrides={{
        Root: {
          style: {
            ...
            'backgroundColor': activeType === type ? theme.colors.primary : theme.colors.backgroundSecondary,
            'color': activeType === type ? theme.colors.white : theme.colors.contentPrimary,
            ':hover': {
              backgroundColor: activeType === type ? theme.colors.primary700 : theme.colors.backgroundTertiary,
            },
          },
        },
      }}
                      ...
                      items={actionGroups[group]?.map((action, idx) => (
                        <div key={action.id} className={styles.actionItem}>
                          ...
                          <div className={styles.actionOperation}>
                            ...
                            >
                              {action.mode === 'built-in' && !isAdmin ? t('View') : t('Update')}
                            </Button>
                            <Button
                              size='mini'
                              kind='secondary'
